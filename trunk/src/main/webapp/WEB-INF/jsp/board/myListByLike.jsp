...
<div id="board_list_by_like" class="main_board_area">
	...
	<div id="likeboard_class_chk" class="table">
		...
		<c:if test="${!empty myListByLike}">
		<c:forEach var="list" items="${myListByLike}">
		<input type="hidden" class="myListByLikeCount" value="0">
	...
	<c:if test="${stopList ne 1}">
		<div class="more_myListByLike_btn" style="text-align:center; margin-top:10px;"><a href="javascript:getMyListByLike()">게시글 더보기</a></div>
	</c:if>
